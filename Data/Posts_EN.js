...
},
{
  ...
  title: "Rehabilitation and Exercises",
  body: [
{
  thumbnail: require("../assets/rehab_thumbnail.jpeg"),
  ...
  body: [
    ...
    {
      type: "p",
      content: "Sit down on a chair and raise one leg.",
    },
    {
      type: "img",
    ...
    {
      type: "p",
      content: "Point your toes towards yourself.",
    },
    {
      type: "img",
...
},
{
  thumbnail: require("../assets/rehab_thumbnail.jpeg"),
  title: "One Leg Stand",
  subtitle: "10 seconds on each leg",
  body: [
    {
      type: "h1",
      content: "Step 1",
    ...
    {
      type: "p",
      content: "Stand up straight with support.",
    },
    {
      type: "img",
    ...
    {
      type: "p",
      content: "Raise up one leg and hold for 10 seconds before switching to the other leg.",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Raise heel up and down.",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Support wrist with free hand",
    },
    {
      type: "img",
    ...
    {
      type: "p",
      content: "Place a bottle in hand.",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Rest arm on table with palm facing upwards",
    },
    {
      type: "img",
    ...
    {
      type: "p",
      content: "Grip the pen and release.",
    },
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Move each finger to touch the thumb",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Sit down and place your hand on your lap",
    },
    {
      type: "img",
    ...
    {
      type: "p",
      content: "Use your arm to help turn your torso.",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Start seated with feet behind the knees holding onto a support.",
    },
    {
      type: "img",
...
},
{
  ...
  body: [
    ...
    {
      type: "p",
      content: "Go up and down a single step.",
    },
    {
      type: "img",
  ...
  body: [
{
  thumbnail: require("../assets/stroke.jpg"),
  title: "Quiz",
  subtitle: "Test your stroke knowledge",
  body: [
    {
      type: "h1",
      content: "The disruption of blood flow to the brain causes ______",
    },
    {
      type: "rbtn",
      content:[
    ...
    {
      type: "h1",
      content: "What Is a type of stroke caused by a blocked artery?",
    },
    {
      type: "rbtn",
      content:[
        {
          key:'Cerebral Stroke',
          text:'Cerebral Stroke',
        },
        
        {
          key:'Ischaemic Stroke',
          text:'Ischaemic Stroke',
        },
        {
          key:'Artery Stroke',
          text:'Artery Stroke',
        ...
        {
          key:'Hemorrhagic Stroke',
          text:'Hemorrhagic Stroke',
        },
      ],
      ans:['Ischaemic Stroke']
    },
    {
      type: "h1",
      content: "What is a type of Stroke caused by a burst artery?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "An Ischaemic Stroke that involves a blood clot is called?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "An Ischaemic Stroke that involves a blood clot and fatty plague is called?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "To look out for a stroke, think _ _ _ _",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "What type of restoration improves your ability to do usual functions?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "Contact a stroke caregiver or a _____ in the community to get more help after a stroke.",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "Which of the stroke Risk Factors CAN be controlled?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "Which of the stroke Risk Factors CANNOT be controlled?",
    },
    {
      type: "rbtn",
      content: [
    ...
    {
      type: "h1",
      content: "Which of the following treatments DO NOT reduce the risk of another stroke?",
    },
    {
      type: "rbtn",
      content: [
        {
          key:'Lifestyle modification',
          text:'Lifestyle modification',
        },
        {
          key:'Cholesterol lowering medicine',
          text:'Cholesterol lowering medicine',
        },
        {
          key:'Anti-Coagulant',
          text:'Anti-Coagulant',
      ...
      ans:['Unhealthy Lifestyle']
    },
    {
      type: "h1",
      content: "One of the ways to reduce the risk of another stroke is to?",
    },
    {
      type: "rbtn",
      content: [
        ...
        {
          key:'Have an unhealthy lifestyle',
          text:'Have an unhealthy lifestyle',
        },
        {
          key:'Not take the medicine prescribed the doctor',
          text:'Not take the medicine prescribed the doctor',
        },

      ],
      ans:['Exercise Regularly']
    },
